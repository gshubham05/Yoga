...
>>>>>>> 6c17d3571813dba7b75033f9b279502075d4a010:yogabest/enroll.html
               ...
               <form method="post" enctype="multipart/form-data">
                     ...
                     <div class="row">
                        <div class="col-md-12 text-center">
                            <button class="btn btn-lg btn-block btn-primary font-weight-bold EnrollClick mt-3" type="submit" name="submit">Entroll Now</button>
                        </div>
                     </div>
                  </form>
                  <?php
